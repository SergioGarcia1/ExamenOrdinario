...
from app.forms import LoginForm, SignUpForm, NoteForm, PublicacionForm
...
def view_Publicaciones():
    ...
    # for note in notes:
    #     salida+=note.body
    return render_template("Publicacioness.html", Publicaciones = Publicaciones)
...
def create_Publicaciones():
    ...
    if form.validate_on_submit():
        ...
        Publicacion.title = form.title.data
